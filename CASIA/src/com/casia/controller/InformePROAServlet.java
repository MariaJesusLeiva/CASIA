...
/**
 * Servlet implementation class InformePROAServlet
 */

public class InformePROAServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static String VERINFPROA = "CrearInformePROA.jsp";
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action.equalsIgnoreCase("verInfPROA")) {
			forward = VERINFPROA;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			PreparedStatement preparedStatement = connection.prepareStatement(
					"SELECT * FROM reservadiasancion WHERE tipo_sancion= 'PROA' AND fecha_inicio='" + fecha + "'");
