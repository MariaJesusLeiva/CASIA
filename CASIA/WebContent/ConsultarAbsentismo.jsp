					...
					<table class="table table-sm" padding="5">
						...
						<tr>
							...
							<td style="text-align: center" class="form"><input class="estilofondogris" readonly="readonly" type="text" name="grupo" size="10"
								placeholder="Ej. 2ºA" value="<c:out value="${absentismo.grupo}"/>"></td>
							<td class="form"></td>						
						</tr>
						<tr>
						...
						<tr>
							<td style="text-align: center" class="form"><input class="estilofondogris" readonly="readonly" type="text" name="acude_fasedos" size="3" placeholder="Sí/No"
						...
						<tr>
							<td style="text-align: center" class="form"><input class="estilofondogris" readonly="readonly" type="text" name="acude_fasetres" size="3" placeholder="Sí/No"
