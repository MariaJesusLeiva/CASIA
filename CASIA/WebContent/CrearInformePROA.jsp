...
<title>Informe PROA</title>
</head>
<%@ include file="Principal.jsp"%>
<body style="background-color: #f4f7f9">
	<div class="text-white text-center d-block mb-1">
		<h3 class="titulo pb-2 pt-2">Creación de Informes para la Sanción de PROA</h3>
	</div>
	<br />
	<div class="container">
		<div class="row">
			<div class="col-md-5">
					<form method="POST" action='InformePROAServlet'
			...
			<div class="col-md-6">
				<div class="panel panel-primary">
					<div class="panel-heading">
						<h3 class="panel-title">PROAS PENDIENTES</h3>
					...
					<table class="table table-hover" id="task-table">
						...
						<tbody class="centrado">
							<c:forEach items="${proas}" var="proa">
								<tr>
