			...
			<div class="col-md-6">
				<form method="POST" action='InfJuridicaServlet'
					...
					<table class="table table-sm">
						<tr class="trfila">
							...
							<td class="form"><input class="estilofondogris" type="text"
								name="curso" size="10"
								value="<c:out value="${infjuridica.curso}" />"
						...
						<tr class="trfila">
							...
							<td class="form"><input class="estilofondogris" type="text"
								name="grupo" size="10"
								value="<c:out value="${infjuridica.grupo}" />"
								readonly="readonly"></td>
						</tr>
						<tr class="trfila">
							...
							<td class="form"><input class="estilofondogris" type="text"
								...
								value="<c:out value="${infjuridica.nombre_alum}"/>"
								readonly="readonly"></td>
						</tr>
						<tr class="trfila">
						...
						<tr class="trfila">
							...
							<td class="form"><textarea class="estilotextareagris2"
									name="inf_juridica" readonly="readonly" rows="10" cols="75"><c:out
										value="${infjuridica.inf_juridica}" /></textarea></td>
						</tr>
						<tr class="trfila">
							...
							<td class="form"><input class="estilofondogris" type="text"
								...
								value="<c:out value="${infjuridica.documentacion}"/>"
								readonly="readonly"></td>
						</tr>
					</table>
					<div class="row mt-3 mb-3">
						<div class="col-12">
							<a
								href="InfJuridicaServlet?action=modificarInfJuridica&id_juridica=<c:out value="${infjuridica.id_juridica}"/>"
