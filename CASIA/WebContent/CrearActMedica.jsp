...
<title>Crear Actuación Médica</title>
</head>
...
<div class="text-white text-center d-block mb-1">
		<h3 class="titulo pb-2 pt-2">Formulario para Actuación Médica</h3>
					...
					<div class="row mt-3 mb-3">
						<div class="col-12">
							<button class="btn btn-primary w-100 no-print" type="submit"
								onclick="return confirm('¿Está seguro de crear la actuación médica?');"
					...
					<table class="table table-hover" id="task-table" align="center">
						...
						<tbody class="centrado">
							<c:forEach items="${actuaciones}" var="actuacion">
								...
								<td><a
										href="ActMedicaServlet?action=verActuacion&id_actuacion=<c:out value="${actuacion.id_actuacion}"/>"><i
