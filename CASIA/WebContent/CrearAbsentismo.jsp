			...
			<div class="col-12 mt-4">
				...
				<form method="POST" action='AbsentismoServlet' name="frmAddabsentismo">
					<table class="table table-sm" padding="5">
						...
						<tr>
							<td style="text-align: center" class="form"><input type="number" min="1" max="9999999999" name="codigo_absen"
						...
						<td colspan="6" class="titulofase"><h4>FASE 1</h4></td>
							...
							<td class="form"><input type="text" name="fechacarta_faseuno"
						...
						<tr>	
							...
							<td class="form"><input type="text" name="fechacarta_fasedos"
						...
						<tr style="border-bottom: 5px #41719C solid">
							...
							<td style="text-align: center" class="form"><input type="text" name="mayor_edad"
								size="3" placeholder="Sí/No"
