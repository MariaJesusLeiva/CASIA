			...
			<div class="col-md-6">
				...
				<form method="POST" action='ReunionServlet' name="frmAddReunion">
					<table class="table table-md">
						<tr class="trreunion">
							...
							<td class="form"><input type="text" name="curso"
								size="10" placeholder="Ej. 17/18" value="<c:out value="${reunion.curso}"/>"required></td>
						</tr>
						<tr class="trreunion">							
							<td class="titulo">Fecha <span class="text-danger">*</span></td>
							<td class="form"><input type="date" name="fecha_reunion" pattern="yyyy-MM-dd"
						...
						<tr class="trreunion">
							...
							<td class="form"><input type="text" name="lugar_reunion"
								size="30"  value="<c:out value="${reunion.lugar_reunion}"/>"required></td>
						<tr class="trreunion2">
						<td class="titulo">Asistente 1</td>
							<td class="form"><input type="text" name="asistente1"
								size="40" placeholder="Apellido1 Apellido2, Nombre" value="<c:out value="${reunion.asistente1}"/>"></td>
						</tr>
						<tr class="trreunion3">	
						...
						<td class="titulo">Asistente 2</td>
							<td class="form"><input type="text" name="asistente2"
								size="40" placeholder="Apellido1 Apellido2, Nombre" value="<c:out value="${reunion.asistente2}"/>"></td>
						</tr>
						<tr class="trreunion3">	
							<td class="titulo">En calidad de</td>
							<td class="form"> <div class="select-wrapper">
						...
						<td class="titulo">Asistente 3</td>
							<td class="form"><input type="text" name="asistente3"
								size="40" placeholder="Apellido1 Apellido2, Nombre" value="<c:out value="${reunion.asistente3}"/>"></td>
						</tr>
						<tr class="trreunion3">	
							<td class="titulo">En calidad de</td>
							<td class="form"> <div class="select-wrapper">
						...
						<td class="titulo">Asistente 4</td>
							<td class="form"><input type="text" name="asistente4"
								size="40" placeholder="Apellido1 Apellido2, Nombre" value="<c:out value="${reunion.asistente4}"/>"></td>
						</tr>
						<tr class="trreunion3">	
							<td class="titulo">En calidad de</td>
							<td class="form"> <div class="select-wrapper">
						...
						<td class="titulo">Asistente 5</td>
							<td class="form"><input type="text" name="asistente5"
								size="40" placeholder="Apellido1 Apellido2, Nombre" value="<c:out value="${reunion.asistente5}"/>"></td>
						</tr>
						<tr class="trreunion3">	
							<td class="titulo">En calidad de</td>
							<td class="form"> <div class="select-wrapper">
					...
					<div class="row mt-3 mb-3">
						<div class="col-12">
							<button class="btn btn-primary w-100 no-print" type="submit" onclick="return confirm('¿Está seguro de crear la reunión?');"
