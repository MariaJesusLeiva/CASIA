...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-6">
				<br /> <b>Registrar Nuevo Usuario</b>
				<form method="POST" action='UsuarioServlet' name="frmAddUsuario">
					<table class="table table-sm">
						...
						<tr class="trfila">
							...
							<td class="form"><input type="text" required
								name="pass_usermd5"
								onkeyup="this.form.pass_user.value=md5(this.form.pass_usermd5.value)">
					...
					<div class="row mt-3 mb-3">
						<div class="col-12">
							<button class="btn btn-primary w-100 no-print" type="submit"
								onclick="return confirm('¿Está seguro de crear el usuario?');"
						...
						<tbody class="centrado">
							<c:forEach items="${usuarios}" var="user">
								<tr>
									...
									<td><a
										href="UsuarioServlet?action=eliminarUsuario&id_user=<c:out value="${user.id_user}"/>"
