				...
				<form method="POST" action='AcosoServlet' name="frmconsultarAcoso">
					<table class="table table-sm">
						...
						<tr class="trfila">
							...
							<td colspan="3" class="form"><textarea
									class="estilotextareacongris" id="textarea"
									name="inf_aportada" readonly="readonly"><c:out
						...
						<tr class="trfila">
							...
							<td colspan="3" class="form"><textarea
									class="estilotextareacongris" id="textarea"
									name="medidas" readonly="readonly"><c:out
										value="${acoso.medidas}" /></textarea>
						</tr>
						<tr class="trfila">
							<td class="titulo">Inicio del Protocolo</td>
							<td colspan ="3" class="form"><input class="estilofondogris" type="text" name="inicio_protocolo"
					...
					<div class="row mt-3 mb-3">
						<div class="col-12">
							<a href="AcosoServlet?action=modificarAcoso&id_acoso=<c:out value="${acoso.id_acoso}"/>" class="btn btn-primary w-100 no-print">Modificar</a>
