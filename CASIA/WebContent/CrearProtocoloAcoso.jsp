			...
			<div class="col-md-6">
				<form method="POST" action='AcosoServlet' name="frmaddAcoso">
					<table class="table table-sm">
						<tr class="trfila">
							...
							<td class="form"><input type="text" name="curso"
								size="10" placeholder="Ej. 17/18" value="<c:out value="${acoso.curso}" />"
								required></td>							
						</tr>
						<tr class="trfila">
							<td class="titulo">Alumno <span class="text-danger">*</span></td>
							<td class="form"><input type="text" name="nombre_alum"
								size="40" placeholder="Apellido1 Apellido2, Nombre" value="<c:out value="${acoso.nombre_alum}"/>"
								required></td>
						...
						<tr class="trfila2">	
							...
							<td colspan ="3" class="form"> <div class="select-wrapper">
									<select name="tipo" required
										style="border: 0; white-space: pre-wrap; white-space: -moz-pre-wrap;" required>
						...
						<tr class="trfila2">	
							...
							<td class="form"><input type="date" name="fecha_reunion" pattern="yyyy-MM-dd"
								value="<c:out value="${acoso.fecha_reunion}"/>"	></td>
							...
							<td colspan="3" class="form"><textarea
									...
									name="asistentes" onkeypress="return limita(event, 500);"
						...
						<tr class="trfila">
							...
							<td colspan="3" class="form"><textarea
									class="estilograndetextareacon" id="textarea3"
									name="medidas" onkeypress="return limita(event, 1000);"
									onkeyup="actualizaInfo(1000)"
					...
					<div class="row mt-3 mb-3">
						<div class="col-12">
							<button class="btn btn-primary w-100 no-print" type="submit" onclick="return confirm('¿Está seguro de crear el protocolo de acoso?');"
