...
<body style="background-color: #f4f7f9">
	<div class="text-white text-center d-block mb-1">
		<h3 class="titulo pb-2 pt-2">
			Modificar Sanción Correspondiente al Parte (<a href="ParteServlet?action=verParte&id_parte=<%=session.getAttribute("codigoparte")%>"><i><%=session.getAttribute("codigoparte")%></i></a>)
		</h3>
	</div>
	<div class="container">
		<div class="row">
