					...
					<table class="table table-sm">
						...
						<tr class="trfila">
							...
							<td class="form"><input class="estilofondogris" type="text" name="nombre_alum"
								size="40"
								value="<c:out value="${infmedica.nombre_alum}"/>" readonly="readonly"></td>
						</tr>
						<tr class="trfila">	
							<td class="titulo">Fecha Nacimiento <span
								class="text-danger">*</span></td>
							<td class="form"><input class="estilofondogris" type="date" name="fecha_nacimiento"
								value="<c:out value="${infmedica.fecha_nacimiento}"/>" readonly="readonly"></td>
						</tr>
						<tr class="trfila">
							<td class="titulo">Información </td>
							<td class="form"><textarea class="estilotextareagris2" name="inf_medica" readonly="readonly"
									rows="10" cols="75"><c:out value="${infmedica.inf_medica}"/></textarea></td>
						</tr>
						<tr class="trfila">
							...
							<td class="form"><input class="estilofondogris" type="text" name="documentacion" size="3"
								value="<c:out value="${infmedica.documentacion}"/>" readonly="readonly"></td>
						</tr>
						<tr class="trfila">
							<td class="titulo">Aporta Medicación <span class="text-danger">*</span></td>
							<td class="form"><input class="estilofondogris" type="text" name="medicacion"
								size="3" value="<c:out value="${infmedica.medicacion}"/>" readonly="readonly"></td>

						</tr>
					</table>
					<div class="row mt-3 mb-3">
						<div class="col-12">
							<a href="InfMedicaServlet?action=modificarInfMedica&id_medica=<c:out value="${infmedica.id_medica}"/>" class="btn btn-primary w-100 no-print">Modificar</a>
