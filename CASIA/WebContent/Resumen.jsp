					...
					<table class="table table-sm">
						...
						<tbody class="centrado">
							<c:forEach items="${recreohoy}" var="recreohoy">
								<tr class="hoy">
									<td class="hoy"><b><c:out value="${recreohoy.nombre_alum}" /></b></td>								
								</tr>
							</c:forEach>
						</tbody>
					</table>
					...
					<table class="table table-sm">
						...
						<tbody class="centrado">
							<c:forEach items="${proahoy}" var="proahoy">
								<tr class="hoy">
									<td class="hoy"><b><c:out value="${proahoy.nombre_alum}" /></b></td>								
								</tr>
							</c:forEach>
						</tbody>
					</table>
					...
					<table class="table table-sm">
						...
						<tbody class="centrado">
							<c:forEach items="${expulsionact}" var="expact">
								<tr class="hoy">
									<td class="hoy"><b><c:out value="${expact.nombre_alum}" /></b></td>								
								</tr>
							</c:forEach>
						</tbody>
					</table>
