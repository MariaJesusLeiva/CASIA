...
<title>Consultar Act. Médica</title>
</head>
...
<div class="text-white text-center d-block mb-1">
		<h3 class="titulo pb-2 pt-2">Actuación Médica</h3>
				...
				<input type="text" name="id_actuacion" style="display: none"
					...
					<table class="table table-sm">
						...
						<tr class="trfila">	
							...
							<td class="form"><input class="estilofondogris" type="date" name="fecha_actuacion"
								value="<c:out value="${actmedica.fecha_actuacion}"/>" readonly="readonly"></td>
						...
						<tr class="trfila">
							...
							<td class="form"><input class="estilofondogris" type="text" name="nombre_alum"
								size="40"
								value="<c:out value="${actmedica.nombre_alum}"/>" readonly="readonly"></td>
						<tr class="trfila">
							<td class="titulo">Observación</td>
							<td class="form"><textarea class="estilotextareagris2" name="observacion" readonly="readonly"
									rows="10" cols="75"><c:out value="${actmedica.observacion}"/></textarea></td>
						</tr>
					</table>
					<div class="row mt-3 mb-3">
						<div class="col-12">
							<a href="ActMedicaServlet?action=modificarActMedica&id_actuacion=<c:out value="${actmedica.id_actuacion}"/>" class="btn btn-primary w-100 no-print">Modificar</a>
