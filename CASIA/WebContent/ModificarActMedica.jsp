...
<title>Modificar Act. Médica</title>
</head>
...
<div class="text-white text-center d-block mb-1">
		<h3 class="titulo pb-2 pt-2">Modificar Actuación Médica</h3>
					...
					<table class="table table-sm">
						...
						<tr class="trfila">
							...
							<td class="form"><textarea
									...
									onkeyup="actualizaInfo(500)"><c:out value="${actmedica.observacion}"/></textarea>
			...
			<div class="col-md-6">
				<div class="panel panel-success">
					<div class="panel-heading">
						<h3 class="panel-title">HISTORIAL ACTUACION MÉDICA</h3>
					...
					<table class="table table-hover" id="task-table" align="center">
						...
						<tbody class="centrado">
							<c:forEach items="${infmedicas}" var="medica">
								...
								<td><a
										href="ActMedicaServlet?action=verActuacion&id_actuacion=<c:out value="${medica.id_actuacion}"/>"><i
